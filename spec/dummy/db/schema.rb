...
ActiveRecord::Schema.define(:version => 20130528134604) do

  create_table "monologue_categories", :force => true do |t|
    t.string "name"
  end

  create_table "monologue_post_categories", :force => true do |t|
    t.integer "post_id"
